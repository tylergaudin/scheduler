...
/**This defines the AppointmentMonthViewController class.
 */
public class AppointmentMonthViewController implements Initializable {
    ...
    /**Loads the apptTableView and filters the results by the current month.
    ...
    public void initialize(URL url, ResourceBundle rb)
    {
        ...
        {
            if (appointment.getStartTime().isBefore(LocalDateTime.now().plusDays(31))
        ...
        apptTableView.setItems(monthAppointments);
